...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference("Professor.count") do
      post professors_url, params: { professor: { ativo: @professor.ativo, bio: @professor.bio, materia: @professor.materia, nome: @professor.nome } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { ativo: @professor.ativo, bio: @professor.bio, materia: @professor.materia, nome: @professor.nome } }
