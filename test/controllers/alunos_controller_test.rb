...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference("Aluno.count") do
      post alunos_url, params: { aluno: { ativo: @aluno.ativo, depoimento: @aluno.depoimento, email: @aluno.email, nome: @aluno.nome, telefone: @aluno.telefone, turma: @aluno.turma } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { ativo: @aluno.ativo, depoimento: @aluno.depoimento, email: @aluno.email, nome: @aluno.nome, telefone: @aluno.telefone, turma: @aluno.turma } }
